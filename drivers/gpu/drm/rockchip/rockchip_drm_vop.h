...
struct vop_alpha_extension {
	struct vop_reg dst_alpha_ctl;
	struct vop_reg src_alpha_ctl;
};

struct vop_alpha_regs {
	struct vop_reg alpha_en;
	struct vop_reg alpha_value;
...
struct vop_win_phy {
	...
	const struct vop_alpha_regs *alpha;
	const struct vop_alpha_extension *alpha_ext;
