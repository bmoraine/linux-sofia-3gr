...
static const struct vop_alpha_extension rk3288_win01_alpha_ext = {
	.src_alpha_ctl = VOP_REG(RK3288_WIN0_SRC_ALPHA_CTRL, 0xff, 0),
	.dst_alpha_ctl = VOP_REG(RK3288_WIN0_DST_ALPHA_CTRL, 0xff, 0),
};

static const struct vop_alpha_extension rk3288_win23_alpha_ext = {
...
static const struct vop_win_phy rk3288_win01_data = {
	...
	.alpha_ext = &rk3288_win01_alpha_ext,
...
static const struct vop_win_phy rk3288_win23_data = {
	.alpha_ext = &rk3288_win23_alpha_ext,
...
static const struct vop_intr rk3288_vop_intr = {
	...
	.status = VOP_REG_MASK(RK3288_INTR_CTRL0, 0xf, 0),
	.enable = VOP_REG_MASK(RK3288_INTR_CTRL0, 0xf, 4),
	.clear = VOP_REG_MASK(RK3288_INTR_CTRL0, 0xf, 8),
};
...
static const struct vop_alpha_regs rk3036_win0_alpha = {
	.alpha_en = VOP_REG(RK3036_ALPHA_CTRL, 0x1, 0),
	.alpha_value = VOP_REG(RK3036_ALPHA_CTRL, 0xff, 4),
	.alpha_mode = VOP_REG(RK3036_DSP_CTRL0, 0x1, 18),
	.alpha_pre_mul = VOP_REG(RK3036_DSP_CTRL0, 0x1, 29),
};

static const struct vop_alpha_regs rk3036_win1_alpha = {
	.alpha_en = VOP_REG(RK3036_ALPHA_CTRL, 0x1, 1),
	.alpha_value = VOP_REG(RK3036_ALPHA_CTRL, 0xff, 12),
...
static const struct vop_ctrl sofia3gr_ctrl_data = {
	.standby = VOP_REG(RK3036_SYS_CTRL, 0x1, 30),
	...
	.edpi_halt = VOP_REG(SOFIA3GR_EDPI_CTRL, 0x1, 0),
	.out_mode = VOP_REG(RK3036_DSP_CTRL0, 0xf, 0),
	.pin_pol = VOP_REG(RK3036_DSP_CTRL0, 0xf, 4),
	.htotal_pw = VOP_REG(RK3036_DSP_HTOTAL_HS_END, 0x1fff1fff, 0),
	.hact_st_end = VOP_REG(RK3036_DSP_HACT_ST_END, 0x1fff1fff, 0),
...
static const struct vop_win_phy sofia3gr_win1_data = {
	.data_formats = formats_win_lite,
	.nformats = ARRAY_SIZE(formats_win_lite),
	.enable = VOP_REG(RK3036_SYS_CTRL, 0x1, 1),
	.format = VOP_REG(RK3036_SYS_CTRL, 0x7, 6),
	.rb_swap = VOP_REG(RK3036_SYS_CTRL, 0x1, 19),
	.dsp_info = VOP_REG(SOFIA3GR_WIN1_DSP_INFO, 0x07ff07ff, 0),
	.dsp_st = VOP_REG(SOFIA3GR_WIN1_DSP_ST, 0x0fff0fff, 0),
	.yrgb_mst = VOP_REG(SOFIA3GR_WIN1_MST, 0xffffffff, 0),
	.yrgb_vir = VOP_REG(RK3036_WIN1_VIR, 0x1fff, 0),
};

static const struct vop_win_data sofia3gr_vop_win_data[] = {
	{ .base = 0x00, .phy = &rk3036_win0_data,
	  .type = DRM_PLANE_TYPE_PRIMARY },
	{ .base = 0x00, .phy = &sofia3gr_win1_data,
	  .type = DRM_PLANE_TYPE_CURSOR },
/*	{ .base = 0x00, .phy = &sofia3gr_win1_data,
	  .type = DRM_PLANE_TYPE_OVERLAY }, */
};

static const struct vop_data sofia3gr_vop = {
	.init_table = rk3036_vop_init_reg_table,
	.table_size = ARRAY_SIZE(rk3036_vop_init_reg_table),
	.ctrl = &sofia3gr_ctrl_data,
	.intr = &rk3036_intr,
	.win = sofia3gr_vop_win_data,
	.win_size = ARRAY_SIZE(sofia3gr_vop_win_data),
};
...
static const struct of_device_id vop_driver_dt_match[] = {
	...
	{ .compatible = "rockchip,rk3036-vop",
	  .data = &rk3036_vop },
	{ .compatible = "rockchip,sofia3gr-vop",
	  .data = &sofia3gr_vop },
	{},
};
