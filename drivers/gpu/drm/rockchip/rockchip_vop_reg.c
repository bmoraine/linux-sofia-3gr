...
static const struct vop_ctrl rk3399_ctrl_data = {
	...
	.pin_pol = VOP_REG(RK3399_DSP_CTRL0, 0xf, 4),
...
static const int rk3399_vop_intr[] = {
        FS_INTR,
        0, 0,
        LINE_FLAG_INTR,
        0,
...
static const struct vop_intr rk3399_vop_intr = {
	...
	.status = VOP_REG(RK3399_INTR_STATUS0, 0xf, 0),
	.enable = VOP_REG(RK3399_INTR_EN0, 0xff, 0),
	.clear = VOP_REG(RK3399_INTR_CLEAR0, 0xff, 0),
};

static const struct vop_data rk3399_vop = {
	.init_table = rk3288_init_reg_table,
	.table_size = ARRAY_SIZE(rk3288_init_reg_table),
