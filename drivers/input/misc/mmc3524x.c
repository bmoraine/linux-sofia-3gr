...
static long mmc3524x_ioctl(struct file *file,
	unsigned int cmd, unsigned long arg)
{
	...
	case MMC3524X_IOC_READ:
		...
		if (mmc3xxx_i2c_rx_data(data, 6) < 0) {
			...
			pr_err("MMC3524X_IOC_READ ERROR");
			return -EFAULT;
		}
...
static ssize_t mmc3524x_show(struct device *dev,
...
static ssize_t mmc3524x_fs_read(struct device *dev,
	struct device_attribute *attr, char *buf)
{
...
static ssize_t mmc3524x_fs_write(struct device *dev,
...
static DEVICE_ATTR(read_mag, S_IRUGO | S_IWUSR | S_IWGRP,
	mmc3524x_fs_read, mmc3524x_fs_write);
