...
#define GC2155_AWB_LOCK_REG  0x82
#define GC2155_AE_LOCK_REG   0xb6
#define GC2155_AWB_LOCK_BITS 0x2
#define GC2155_AE_LOCK_BITS  0x1
...
/* disable AWB  */
static struct gc_register gc2155_awb_lock_off_table[] = {
	{ GC_8BIT, 0xfe, 0x00 },
	{ GC_8BIT, 0x82, 0xf8 },
	{GC_TOK_TERM, 0, 0},
};
...
/* enable AWB */
static struct gc_register gc2155_awb_lock_on_table[] = {
	{ GC_8BIT, 0xfe, 0x00 },
	{ GC_8BIT, 0x82, 0xfa },
	{GC_TOK_TERM, 0, 0},
};

static struct gc_table_map gc2155_awb_lock_tables[] = {
	{0x0, gc2155_awb_lock_on_table },
	{0x1, gc2155_awb_lock_off_table  },
};

/* disable AEC */
static struct gc_register gc2155_ae_lock_off_table[] = {
	{ GC_8BIT, 0xfe, 0x00 },
	{ GC_8BIT, 0xb6, 0x00 },
	{GC_TOK_TERM, 0, 0},
};
...
/* enable AEC */
static struct gc_register gc2155_ae_lock_on_table[] = {
	{ GC_8BIT, 0xfe, 0x00 },
	{ GC_8BIT, 0xb6, 0xf1 },
	{GC_TOK_TERM, 0, 0},
};

static struct gc_table_map gc2155_ae_lock_tables[] = {
	{0x0, gc2155_ae_lock_on_table },
	{0x1, gc2155_ae_lock_off_table  },
};
...
*/
	...
	.settings_tables = {
		...
		GC_ADD_SETTINGS_TABLES(GC_SETTING_AWB_LOCK,
			gc2155_awb_lock_tables),
		GC_ADD_SETTINGS_TABLES(GC_SETTING_AE_LOCK,
			gc2155_ae_lock_tables),
	},
