...
#define OV5670_TIMING_Y_INC		0x3815
...
static struct ov_camera_module_config ov5670_configs[] = {
	...
	},
	{
		...
		.auto_gain_enabled = false,
		.auto_wb_enabled = false,
		.reg_table = (void *)OV5670_1080P_30fps,
		.reg_table_num_entries =
			sizeof(OV5670_1080P_30fps)
			/
			sizeof(OV5670_1080P_30fps[0]),
		.v_blanking_time_us = 2000
	},
	{
		.name = "5M_30fps",
		...
		.auto_gain_enabled = false,
		.auto_wb_enabled = false,
		.reg_table = (void *)OV5670_5M_30fps_2lanes,
		.reg_table_num_entries =
			sizeof(OV5670_5M_30fps_2lanes)
			/
			sizeof(OV5670_5M_30fps_2lanes[0]),
		.v_blanking_time_us = 2000
	},
