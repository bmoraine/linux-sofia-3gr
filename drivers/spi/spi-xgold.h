...
/* ==================================DEBUG=============================== */
#define XGOLD_SPI_ISR		(1 << 4)
#define XGOLD_SPI_DEBUG		(1 << 3)
#define XGOLD_SPI_ENTER		(1 << 2)
#define XGOLD_SPI_INFO		(1 << 1)
#define XGOLD_SPI_ERROR		(1 << 0)

#define xgold_spi_level         (XGOLD_SPI_INFO|XGOLD_SPI_ERROR)
#define xgold_spi_debug(level, fmt, arg...) do { \
	if (xgold_spi_level & level)\
		pr_err(fmt, ##arg); \
	} while (0)

#define USIF_IRQNAME_RX_XREQ  "SPI_RX_XREQ_INT"
#define USIF_IRQNAME_RX_BREQ  "SPI_RX_BREQ_INT"
#define USIF_IRQNAME_TX_XREQ  "SPI_TX_XREQ_INT"
#define USIF_IRQNAME_TX_BREQ  "SPI_TX_BREQ_INT"
#define USIF_IRQNAME_AB       "SPI_AB_INT"
#define USIF_IRQNAME_ERR      "SPI_ERR_INT"
#define USIF_IRQNAME_STA      "SPI_STA_INT"
#define USIF_MASK_ISR_STA (USIF_RIS_TX_FIN_MASK \
		| USIF_RIS_FRM_PAUSE_MASK \
		| USIF_RIS_TMO_MASK)

#define USIF_MASK_ISR_ERR (USIF_RIS_MC_MASK \
		| USIF_RIS_SLIP_MASK \
		| USIF_RIS_CRC_MASK \
		| USIF_RIS_PHE_MASK \
		| USIF_RIS_FE_MASK \
...
#define USIF_MASK_ISR_FIFO (USIF_RIS_RX_LSREQ_MASK \
		| USIF_RIS_RX_SREQ_MASK \
		| USIF_RIS_RX_LBREQ_MASK \
		| USIF_RIS_RX_BREQ_MASK \
		| USIF_RIS_TX_LSREQ_MASK \
		| USIF_RIS_TX_SREQ_MASK \
		| USIF_RIS_TX_LBREQ_MASK \
		| USIF_RIS_TX_BREQ_MASK)

#define USIF_SPI_RXFIFO_MASK (USIF_RIS_RX_LSREQ_MASK \
		| USIF_RIS_RX_SREQ_MASK \
		| USIF_RIS_RX_LBREQ_MASK \
		| USIF_RIS_RX_BREQ_MASK)

#define USIF_SPI_TXFIFO_MASK (USIF_RIS_TX_BREQ_MASK | \
			      USIF_RIS_TX_LBREQ_MASK| \
			      USIF_RIS_TX_SREQ_MASK | \
			      USIF_RIS_TX_LSREQ_MASK)

#define USIF_SPI_TX_MASK (USIF_SPI_TXFIFO_MASK | \
			  USIF_RIS_TX_FIN_MASK | \
			  USIF_RIS_TXOF_MASK | \
			  USIF_RIS_TXUR_MASK)

#define USIF_SPI_RX_MASK (USIF_SPI_RXFIFO_MASK | \
			 USIF_RIS_RXOF_MASK | \
			 USIF_RIS_RXUR_MASK)

#define USIF_IMSC_CTRL	(USIF_MASK_ISR_STA \
		| USIF_MASK_ISR_ERR \
		| USIF_MASK_ISR_FIFO)
...
#define USIF_PRTC_CFG_RESSFCIEN_OFFSET 0x1b
#define USIF_PRTC_CFG_RESSFCIEN_WIDTH 0x1
#define USIF_PRTC_CFG_RESSFCIEN_MASK 0x8000000
#define USIF_PRTC_CFG_RESSFCIEN(_reg) (((_reg) & 0x8000000) >> 0x1b)
#define USIF_PRTC_CFG_RESSFCIEN_ZERO (0x0 << USIF_PRTC_CFG_RESSFCIEN_OFFSET)
#define USIF_PRTC_CFG_RESSFCIEN_DIS (0x0 << USIF_PRTC_CFG_RESSFCIEN_OFFSET)
#define USIF_PRTC_CFG_RESSFCIEN_EN (0x1 << USIF_PRTC_CFG_RESSFCIEN_OFFSET)
#define USIF_PRTC_CFG_RESSFCOEN_OFFSET 0x1a
#define USIF_PRTC_CFG_RESSFCOEN_WIDTH 0x1
#define USIF_PRTC_CFG_RESSFCOEN_MASK 0x4000000
#define USIF_PRTC_CFG_RESSFCOEN(_reg) (((_reg) & 0x4000000) >> 0x1a)
#define USIF_PRTC_CFG_RESSFCOEN_ZERO (0x0 << USIF_PRTC_CFG_RESSFCOEN_OFFSET)
#define USIF_PRTC_CFG_RESSFCOEN_DIS (0x0 << USIF_PRTC_CFG_RESSFCOEN_OFFSET)
#define USIF_PRTC_CFG_RESSFCOEN_EN (0x1 << USIF_PRTC_CFG_RESSFCOEN_OFFSET)
...
#define USIF_PRTC_CFG_RESWKUP_OFFSET 0xd
#define USIF_PRTC_CFG_RESWKUP_WIDTH 0x1
#define USIF_PRTC_CFG_RESWKUP_MASK 0x2000
#define USIF_PRTC_CFG_RESWKUP(_reg) (((_reg) & 0x2000) >> 0xd)
#define USIF_PRTC_CFG_RESWKUP_ZERO (0x0 << USIF_PRTC_CFG_RESWKUP_OFFSET)
...
#define USIF_DPLUS_CTRL_SETMASK_NO_UPD (0x0 << USIF_DPLUS_CTRL_SETMASK_OFFSET)
...
#define USIF_IMSC_IMSC_OFFSET 0x0
#define USIF_IMSC_IMSC_WIDTH 0x20
#define USIF_IMSC_IMSC_MASK 0xffffffff
#define USIF_IMSC_IMSC(_reg) (((_reg) & 0xffffffff) >> 0x0)
#define USIF_IMSC_IMSC_INT_DIS (0x0 << USIF_IMSC_IMSC_OFFSET)
#define USIF_IMSC_IMSC_INT_EN (0x1 << USIF_IMSC_IMSC_OFFSET)

#define USIF_MIS_OFFSET  0x88
#define USIF_MIS(_base) ((_base) + 0x88)
#define USIF_MIS_MIS_OFFSET 0x0
#define USIF_MIS_MIS_WIDTH 0x20
#define USIF_MIS_MIS_MASK 0xffffffff
#define USIF_MIS_MIS(_reg) (((_reg) & 0xffffffff) >> 0x0)
#define USIF_MIS_MIS_NO_INT (0x0 << USIF_MIS_MIS_OFFSET)
#define USIF_MIS_MIS_INT_PEND (0x1 << USIF_MIS_MIS_OFFSET)

#define USIF_ISR_OFFSET  0x90
#define USIF_ISR(_base) ((_base) + 0x90)
#define USIF_ISR_ISR_OFFSET 0x0
#define USIF_ISR_ISR_WIDTH 0x20
#define USIF_ISR_ISR_MASK 0xffffffff
#define USIF_ISR_ISR(_reg) (((_reg) & 0xffffffff) >> 0x0)
#define USIF_ISR_ISR_NO_CHANGE (0x0 << USIF_ISR_ISR_OFFSET)
#define USIF_ISR_ISR_SET_INT (0x1 << USIF_ISR_ISR_OFFSET)
...
#define USIF_ICR_ICR_OFFSET 0x0
#define USIF_ICR_ICR_WIDTH 0x20
#define USIF_ICR_ICR_MASK 0xffffffff
#define USIF_ICR_ICR(_reg) (((_reg) & 0xffffffff) >> 0x0)
#define USIF_ICR_ICR_NO_CHANGE (0x0 << USIF_ICR_ICR_OFFSET)
#define USIF_ICR_ICR_CLR_INT (0x1 << USIF_ICR_ICR_OFFSET)
