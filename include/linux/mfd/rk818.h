...
int rk818_i2c_write(struct rk818 *rk818, u8 reg, int count, const u8 src);
...
extern int kernel_power_off(void);
extern int32_t vmm_pmic_reg_read(uint32_t reg_address, uint32_t *p_reg_val);
extern int32_t vmm_pmic_reg_write(uint32_t reg_address, uint32_t reg_val);
extern int32_t vmm_pmic_reg_read_by_range(uint32_t reg_address, uint8_t *data,
					  uint32_t size_in_byte);
extern int32_t vmm_pmic_reg_write_by_range(uint32_t reg_address, uint8_t *data,
					   uint32_t size_in_byte);
