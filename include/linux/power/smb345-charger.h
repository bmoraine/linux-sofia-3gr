...
#ifndef _SMB345_CHARGER_H
#define _SMB345_CHARGER_H 1
 ...
 *
 * return 0 means success */
extern int smb345_charging_toggle(enum charging_toggle_level level, bool on);
