...
typedef enum {
  VPOWER_SYSTEM_STATE_S0 = 0,
  VPOWER_SYSTEM_STATE_S0i0 = 1,
  VPOWER_SYSTEM_STATE_S0i3 = 2,
  VPOWER_SYSTEM_STATE_S3 = 3,
  VPOWER_SYSTEM_STATE_MAX = 0x7FFFFFFF
}
ePOWER_SYSTEM_STATE_T;
