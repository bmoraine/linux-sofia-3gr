/*
 * Component: INTEL AFE ACCESSORY DETECTION INTERFACE
 *
 ...
 */
struct afe_acc_det {
	struct afe_vumic_conf   vumic_conf;	/* /< Vumic acts as a pull
			up voltage for ACD*/
	enum afe_micldo_mode  micldo_mode;	/* /< Micldo mode for ACD*/
	enum afe_xb           xb_mode;	/*/< Central biasing mode for ACD*/
};
